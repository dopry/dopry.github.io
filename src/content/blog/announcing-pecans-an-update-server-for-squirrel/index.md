---
id: edvZBJFVEDkAG7QagFP45
title: Announcing Pecans, an update server for Squirrel
pubDate: 2021-06-29T21:43:28.692Z
author: Darrel O'Pry
description: At [Spaceage.tv](https://spaceage.tv/) , we needed an update server for an Electron app using Squirrel. Our goals were to be able to use Github to manage our releases in our private repo and minimize our infrastructure and operating costs. We reviewed the existing options.
category: Development
images:
  - url: ./sara-cervera-xoclqoltbjs-unsplash.jpg
    alt: Pecans
tags:
  - electron
  - opensource
...
At [Spaceage.tv](https://spaceage.tv/) , we needed an update server for an Electron app using Squirrel. Our goals were to be able to use Github to manage our releases in our private repo and minimize our infrastructure and operating costs. We reviewed the existing options.
